        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2" id="price">
                    <h5 class="special-heading text-center">Escolha um</h5>
                    <h1 class="text-center">Pacote</h1>
                    <p class="text-center big" style="color: black;">Não fique preso a um plano limitado, escolha um de
                        nossos planos de internet ilimitados.</p>
                </div>
            </div>
            ...
            <div class="row c-gutter-60">
                    ...
                    <div class="pricing-plan hero-bg rounded">
                        ...
                        <div class="plan-features">
                            <ul class="list-bordered">
                                ...
                                <li>Abertura de NAT</li>
                                <li>Porta Giga</li>
                                <li>Suporte 24/7</li>
                                <li>Configuração local da TV</li>
                            </ul>
                        </div>
                        <div class="price-wrap d-flex">
                            <span class="plan-sign small-text">Rs</span>
                            <span class="plan-price color-main5">99,90</span>
                            <span class="plan-decimals small-text">/mo</span>
                        </div>
                        <div class="plan-button">
                            <a href="//wa.me/5516997115735?text=Olá, vi o anuncío de seus planos no site, e me interessei pelo plano de 400mb" target="_blank"
                                class="btn btn-maincolor3"><span>Assinar</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="pricing-plan hero-bg rounded">
                        ...
                        <div class="price-wrap d-flex">
                            <span class="plan-sign small-text">Rs</span>
                            <span class="plan-price color-main3">109,90</span>
                            <span class="plan-decimals small-text">/mo</span>
                        </div>
                        <div class="plan-button">
                            <a href="//wa.me/5516997115735?text=Olá, vi o anuncío de seus planos no site, e me interessei pelo plano de 500mb" target="_blank"
                                class="btn btn-maincolor2"><span>Assinar</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="pricing-plan hero-bg rounded">
                        ...
                        <div class="price-wrap d-flex">
                            <span class="plan-sign small-text">Rs</span>
                            <span class="plan-price color-main2">119,90</span>
                            <span class="plan-decimals small-text">/mo</span>
                        </div>
                        <div class="plan-button">
                            <a href="//wa.me/5516997115735?text=Olá, vi o anuncío de seus planos no site, e me interessei pelo plano de 600mb" target="_blank"
                                class="btn btn-maincolor"><span>Assinar</span></a>
                        </div>
                    </div>
